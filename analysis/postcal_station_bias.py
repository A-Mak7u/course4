...
OUT = PROJECT_ROOT / "outputs_runs" / RUN
os.makedirs(OUT, exist_ok=True)

INPUT = PROJECT_ROOT / "outputs_runs" / "20250914_220035_infer_extra_fix" / "predictions.csv"  # путь к predictions extra модели
...
with open(OUT / "metrics_biascorr.txt","w") as f:
    f.write("=== BEFORE ===\n")
...
by_station.to_csv(OUT / "metrics_by_station_corr.csv", index=False)
...
plt.savefig(OUT / "scatter_biascorr.png", dpi=150)
plt.close()
